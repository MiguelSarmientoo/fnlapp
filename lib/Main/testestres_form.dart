...
@override
  ...
  final url = Uri.parse('http://18.225.10.73:3000/api/guardarTestEstres'); // URL para guardar el test de estrés
  final updateEstresUrl = Uri.parse('http://18.225.10.73:3000/api/userestresessions/assign'); // URL para actualizar el estres_nivel_id
  final programaUrl = Uri.parse('http://18.225.10.73:3000/api/userprograma/report/$userId'); // URL para generar el programa
  ...
  try {
    ...
    final genderResponse = await http.get(
      Uri.parse('http://18.225.10.73:3000/api/userResponses/$userId'),
    );
...
Future<void> sendAsyncProgramaRequest(String userId, Map<String, dynamic> data) async {
  final programaUrl = Uri.parse('http://18.225.10.73:3000/api/userprograma/report/$userId');
